...
public enum AccountErrorCode implements BaseErrorCode {
    ...
    ROLE_NOT_FOUND(OK, "ACC-011", "Role không hợp lệ", new HashMap<>()),
    NEW_PASSWORD_MUST_BE_DIFFERENT(OK, "ACC-012", "Mật khẩu mới trùng với mật khẩu hiện tại", new HashMap<>()),
    CANNOT_UPDATE_YOURSELF(OK,"ACC-013","Không thể tự thay đổi trạng thái của chính mình",new HashMap<>()),
    CANNOT_UPDATE_ADMIN(OK, "ACC-014", "Không thể thay đổi trạng thái của tài khoản admin khác", new HashMap<>()),
    ;
